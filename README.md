...
This repository contains the Design for Visual Systems laboratory logbook (lab 5 & 6) created by **Yinuo Pang(06060377)**. Each lab folder is organised to document both the learning process and technical outputs, and includes:
